package com.md.spacelabs.entitystore;
...
import com.md.spacelabs.entitystore.model.EntityDefinition;
...
public class EntityStoreAccess {
	...
	private UserAccessService userService = new GAEOpenIDUserAccessService();
